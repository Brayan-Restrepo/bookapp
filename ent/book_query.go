...
func (bq *BookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Book, error) {
	...
	if query := bq.withAuthor; query != nil {
		if err := bq.loadAuthor(ctx, query, nodes, nil,
			func(n *Book, e *User) { n.Edges.Author = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (bq *BookQuery) loadAuthor(ctx context.Context, query *UserQuery, nodes []*Book, init func(*Book), assign func(*Book, *User)) error {
